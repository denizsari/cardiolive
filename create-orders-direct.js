    ...
    const ordersData = [
      {
        ...
        createdAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000), // 7 days ago        updatedAt: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000)  // 5 days ago
      },
      {
        user: user._id,
        orderNumber: 'CL000002',
        items: [
          {
      ...
      },
      {
        ...
        createdAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000), // 1 day ago        updatedAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000)  // 1 day ago
      },
      {
        user: user._id,
        orderNumber: 'CL000004',
        items: [
          {
